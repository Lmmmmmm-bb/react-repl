...
const SelectTriggerWithIcon: FC<ComponentProps<typeof SelectPrimitive.Trigger> & { hiddenIcon?: boolean }>
= ({ className, children, hiddenIcon, ...props }) => (
...
const SelectScrollUpButton: FC<ComponentProps<typeof SelectPrimitive.ScrollUpButton>> = ({ className, ...props }) => (
